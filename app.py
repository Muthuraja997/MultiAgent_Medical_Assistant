...
def chat(
    ...
    try:
        ...
        print(f"[DEBUG] Query processed successfully. Response keys: {response_data.keys()}")
        ...
        print(f"[DEBUG] Response text extracted: {len(response_text)} characters")
        ...
        print(f"[DEBUG] Returning result with status 'success'")
        return result
    except Exception as e:
        import traceback
