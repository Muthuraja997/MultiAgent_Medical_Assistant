...
class RAGConfig:
    def __init__(self):
        ...
        self.vector_local_path = "../common/data/qdrant_db"  # Path to common directory
        self.doc_local_path = "../common/data/docs_db"
        self.parsed_content_dir = "../common/data/parsed_docs"
...
class MedicalCVConfig:
    def __init__(self):
        ...
        self.skin_lesion_segmentation_output_path = "../common/uploads/skin_lesion_output/segmentation_plot.png"
        self._llm = None  # Lazy initialization
        self._temperature = 0.1
